import { expandVehiclePrices, vehicleTypeSlug, type Route, type VehiclePrice } from "@/types/route";
...
export function findComboVehiclePrice(route: Route, vehicleSlug: string): VehiclePrice | undefined {
  return expandVehiclePrices(route.pricingByVehicle).find((vp) => vehicleTypeSlug(vp.vehicleType) === vehicleSlug);
}
