...
Thiết kế giao diện quản trị nội bộ mobile-first cho Gocar VN bằng React/Next.js App Router. Đây là working surface, không phải landing page.
...
- Gocar VN: deep navy, teal, amber và warm cream; Be Vietnam Pro cho nội dung, Archivo cho tiêu đề.
