...
## SEO independent verification and Paid v2 — 25/09/2026

- Organic Growth independently checked Preview `f08c38d`: homepage, route list and price list contain no Long Thành route links; Route 9190 and its 4-seat combo remain `noindex, follow` without booking form or commercial schema. It marked SEO-006A/006B **partial**, DEP-002 **pending**, and did not validate the five other combos, other Long Thành routes or the Preview sitemap response.
- Organic Growth decided that the current Long Thành hub stays `noindex, follow` and PRELAUNCH. The sitemap conflict remains **unverified at Preview response level**; no sitemap, canonical, redirect, domain or CMS data is changed here.
- Organic Growth identified the hub's “Sài Gòn” province link leading to `/tuyen-duong/ho-chi-minh` (404) and the unscoped 1.500K title/Service description on Route 9117 despite a separate inbound round-trip Offer at 1.400K. This follow-up filters hub province links against actual active route regions and renders price-neutral title/description when a Route Pair's Offer floor is lower than its featured outbound price. Offer amounts, direction, canonical and Service name are unchanged. SEO must independently recheck the rendered output on the next Preview; this source edit is not SEO VERIFY PASS.
- Paid Growth v2 confirms AC01–AC06 at definition/source level and leaves AC07–AC13 blocked. PAID-002 is `GROWTH VERIFY — SOURCE PARTIAL PASS / BLOCKED FOR CLOSURE`; budget, campaigns and production advertising remain inactive. Privacy/retention decision, multi-visit attribution, isolated WordPress staging, Operations facts, D35-10 and DEP-011 remain outstanding.
