...
function rest_do_request( $request ) { $GLOBALS['creates'] = ( $GLOBALS['creates'] ?? 0 ) + 1; $GLOBALS['posts'][200] = 'booking_request'; Gocar_Lead_Lifecycle::legacy_create( new WP_Post( 200, 'booking_request' ), $request, true ); return new FakeResponse( array( 'id' => 200 ) ); }
...
class FakeResponse { public function __construct( private array $data ) {} public function is_error() { return false; } public function get_data() { return $this->data; } }
