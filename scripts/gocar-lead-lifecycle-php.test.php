...
$spoofed = Gocar_Lead_Lifecycle::attribution( array( 'consent_state' => 'granted', 'utm_source' => 'google', 'utm_medium' => 'organic', 'landing_path' => '/tuyen-duong/vung-tau/' ) );
...
$paid = Gocar_Lead_Lifecycle::attribution( array( 'consent_state' => 'granted', 'utm_source' => 'google', 'utm_medium' => 'cpc', 'landing_path' => '/tuyen-duong/vung-tau/' ) );
check( 'paid_search' === $paid['lead_touch']['channel_group'], 'paid UTM remains distinct from organic' );
$referral = Gocar_Lead_Lifecycle::attribution( array( 'consent_state' => 'granted', 'referrer_origin' => 'https://example.org/path?email=private', 'landing_path' => '/' ) );
...
$direct = Gocar_Lead_Lifecycle::attribution( array( 'consent_state' => 'granted', 'referrer_origin' => 'https://alodatxe.com/', 'landing_path' => '/' ) );
...
$unknown_consent = Gocar_Lead_Lifecycle::attribution( array( 'utm_source' => 'google', 'utm_medium' => 'cpc', 'referrer_origin' => 'https://www.google.com/search?q=private', 'landing_path' => '/' ) );
check( 'unknown' === $unknown_consent['attribution_status'] && 'unknown' === $unknown_consent['lead_touch']['channel_group'] && null === $unknown_consent['lead_touch']['landing_path'] && null === $unknown_consent['attributed_touch'], 'unknown consent does not persist or attribute marketing context' );
check( 0 === ( $GLOBALS['creates'] ?? 0 ), 'contact click does not create a lead' );
$key = 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa';
$req = new WP_REST_Request(); $req->set_body_params( array( 'idempotency_key' => $key, 'booking' => array( 'title' => 'Test', 'meta' => array( 'so_dien_thoai' => '0900000000' ) ), 'acquisition' => array( 'consent_state' => 'granted', 'source' => 'google', 'medium' => 'cpc' ) ) );
