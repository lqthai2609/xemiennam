...
export async function POST(request: Request) {
  ...
  return NextResponse.json({
    ...
    // Trả lý do để có thể chẩn đoán ngay trong Network response trên production. Không chứa
    // access key hay dữ liệu cá nhân; lead vẫn được coi là đã gửi thành công.
    ...(!notification.sent && { notificationError: notification.reason }),
  });
}
