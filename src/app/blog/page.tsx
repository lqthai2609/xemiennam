...
export default async function BlogPage() {
  ...
  return (
    <main className="site-shell">
      ...
      <UnifiedHero eyebrow="BLOG" title={<>Cẩm nang<br /><em>trước khi lên xe.</em></>} description="Kinh nghiệm du lịch, cẩm nang tuyến đường và review điểm đến — cập nhật đều đặn." showFinder={false} />
