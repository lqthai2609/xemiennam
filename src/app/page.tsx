    ...
    <main className="site-shell">
      <header className="site-header">
        ...
        <nav className={`main-nav ${menuOpen ? "is-open" : ""}`} aria-label="Điều hướng chính">
          ...
          <a className="nav-hotline" href="tel:19006789"><Phone size={16} /> 1900 6789</a>
          <Button className="nav-cta" onClick={() => document.getElementById("booking")?.scrollIntoView({ behavior: "smooth" })}>Đặt xe ngay <ArrowRight data-icon="inline-end" /></Button>
        </nav>
