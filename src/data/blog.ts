...
/**
 * Mock tạm cho `post` mặc định WordPress. Production không dùng mock fallback.
 * Day 24 giữ relation arrays tường minh nhưng rỗng: fixture không được tự suy đoán taxonomy
 * hoặc Location ID chỉ từ tiêu đề/nội dung. Khi cần test relation ở development, hãy gắn
 * relation có chủ đích thay vì dùng text matching.
 */
