/**
 * Hằng số dùng chung cho SEO, schema và thông tin liên hệ của Gocar VN.
 *
...
export const SITE_DESCRIPTION =
  "Gocar VN cung cấp dịch vụ cho thuê xe nguyên chiếc 4–45 chỗ và limousine cho các tuyến TP.HCM, sân bay và khu vực Nam Bộ — chủ động giờ giấc, an toàn và minh bạch.";
